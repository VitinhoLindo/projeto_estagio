  ...
  <div class="information" v-if="processedData">
    <div class="detail">
      <div class="label-form">
        <label>{{ language.labels['information-iten-label'] }}</label>
      </div>
      ...
      <div class="fields">
        ...
        <div class="field">
          <div class="content">
            <div class="label">
              {{ language.labels['field-mark'] }}
            </div>
            <div class="value" v-if="!processed.marca.update" v-on:click="updateData('marca')">
              {{ marca }}
            </div>
            <div class="value" v-else v-on:input="changeData('marca')" v-on:mouseleave="changeData('marca')">
              <select v-model="processed.marca.modified">
                <option v-for="(mark, index) in marks" v-bind:value="mark.id" v-bind:key="index">
                  {{ mark.nome }}
                </option>
              </select>
            </div>
